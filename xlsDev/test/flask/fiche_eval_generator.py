...
def writeout(lista, job):
    source = open_workbook("test.xlsx", formatting_info=True).sheet_by_index(
        1)  # Ouverture du fichier test.xlsx avec xlrd
    buffer = 19
            ...
            if rowsx < 19:
                ...
                for row, data in enumerate(lista):
                    ...
                    for col, element in enumerate(data):
                        ...
                        wb2.write(offset, col, element,
                                  plain)  # ici element correspond également à la colonne de chaque liste
